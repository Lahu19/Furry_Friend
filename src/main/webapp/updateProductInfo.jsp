                      ...
                      %>
									<div class="form-group">
										<label>Product ID</label> <input type="text"
											class="form-control" value="<%=obj.getId() %>" name="id"
											required>
									</div>
									<div class="form-group">
										<label>Product Name</label> <input type="text"
											class="form-control" value="<%=obj.getpName() %>"
											name="pName" required>
									</div>
									<div class="form-group">
										<label>Product Quantity</label> <input type="text"
											class="form-control" value="<%= obj.getpQuantity() %>"
											name="pQuantity" required>
									</div>
									<div class="form-group">
										<label>HSN</label> <input type="text" class="form-control"
											value="<%= obj.getpHSN() %>" name="pHSN" required>
									</div>
									<div class="form-group">
										<label>Purchase Date</label> <input type="text"
											class="form-control" value="<%=obj.getpDate() %>"
											name="pDate" required>
									</div>
									<div class="form-group">
										<label>MRP</label> <input type="text" class="form-control"
											value="<%= obj.getpMRP() %>" name="pMRP" required>
									</div>
