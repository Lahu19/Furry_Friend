<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <head>
    ...
    <meta name="title" content="Furry Friends">
    <meta name="description" content="Furry friends selling pets online">
  ...
  <body id="top">
    ...
    <header class="header" data-header>
      <div class="container">
        ...
        <a href="index.jsp" class="logo">Furry Friends</a>
        <!-- #Navbar-->
        <nav class="navbar" data-navbar>
          <ul class="navbar-list">
            ...
            <li class="navbar-item">
              <a href="shop.jsp" class="navbar-link" data-nav-link>Shop</a>
            </li>

            <li class="navbar-item">
              <a href="collection.jsp" class="navbar-link" data-nav-link>Collections</a>
            </li>

            <li class="navbar-item">
              <a href="blog.jsp" class="navbar-link" data-nav-link>Blogs</a>
            </li>
    ...
    <main>
      <article>
        ...
        <section class="section hero has-bg-image" id="home" aria-label="home"
          style="background-image: url('https://images.pexels.com/photos/247522/pexels-photo-247522.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')">
          <div class="container">
            ...
            <ul class="has-scrollbar">
              ...
              <li class="scrollbar-item">
                <div class="category-card">
                  <a href="allCats.jsp" class="card-title">
                    <figure class="card-banner img-holder" style="--width: 330; --height: 300;">
                      <img
                        src="https://encrypted-tbn1.gstatic.com/licensed-image?q=tbn:ANd9GcRGpY1lyPCgzIEpOxl20Iz5TodXA8Tuga1v2jWfa77O3kJX6ZtUv1vrTpAxam2il0SwXN2l_Bz0CdXcjDY"
                        width="330" height="300" loading="lazy" alt="Cats" class="img-cover">
                    </figure>
                  </a>
                  <h3 class="h3">
                    <a href="allCats.jsp" class="card-title">Cats</a>
                  </h3>
              ...
              <li class="scrollbar-item">
                <div class="category-card">
                  <a href="alldogs.jsp" class="card-title">
                    <figure class="card-banner img-holder" style="--width: 330; --height: 300;">
                      <img
                        src="https://images.saymedia-content.com/.image/ar_1:1%2Cc_fill%2Ccs_srgb%2Cq_auto:eco%2Cw_1200/MTk2NTQxNDcwMTUxMjg4NjM4/13-things-to-consider-before-buying-a-golden-retriever.png"
                        width="330" height="300" loading="lazy" alt="Cat Toys" class="img-cover">
                    </figure>
                  </a>
                  <h3 class="h3">
                    <a href="alldogs.jsp" class="card-title">Dogs</a>
                  </h3>
              ...
              <li class="scrollbar-item">
                <div class="category-card">
                  ...
                  <h3 class="h3">
                    <a href="shop.jsp" class="card-title">Animal Food</a>
                  </h3>
              ...
              <li class="scrollbar-item">
                <div class="category-card">
                  ...
                  <h3 class="h3">
                    <a href="allProducts.jsp" class="card-title">Cat Toys</a>
                  </h3>
              ...
              <li>
                <div class="product-card">
                  ...
                  <div class="card-content">
                    ...
                    <data class="card-price" value="15">150Rs</data>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div class="product-card">
                  ...
                  <div class="card-content">
                    ...
                    <data class="card-price" value="45">450Rs</data>
              ...
              <li>
                <div class="product-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="#" class="card-title"> Wardely Shrimp Pellets</a>
                    </h3>
              ...
              <li>
                <div class="product-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="#" class="card-title">Fruit Blend Parrot Food</a>
                    </h3>

                    <data class="card-price" value="49">490Rs</data>
              ...
              <li>
                <div class="product-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="#" class="card-title">Toys</a>
                    </h3>

                    <data class="card-price" value="85">850Rs</data>
              ...
              <li>
                <div class="product-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="#" class="card-title">Comfort Fragrance for Cats</a>
                    </h3>
              ...
              <li>
                <div class="product-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="#" class="card-title">Proplane Food for Dogs</a>
                    </h3>
              ...
              <li>
                <div class="product-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="#" class="card-title">Urinary Care for Dogs</a>
                    </h3>

                    <data class="card-price" value="55">550Rs</data>
            ...
            <ul class="grid-list">
              ...
              <li>
                <div class="service-card">
                  ...
                  <p class="card-text">
                    Order by 2:00 pm local time to get free delivery on orders 3500+ today.
                  </p>
              ...
              <li>
                <div class="service-card">
                  ...
                  <p class="card-text">
                    25% off your online order of 5000+. Available at most locations.
                  </p>
              ...
              <li>
                <div class="service-card">
                  ...
                  <p class="card-text">
                    Shop online to get orders over 5000Rs shipped fast and free.
                  </p>
          ...
          <div class="container">
            ...
            <div class="cta-content">
              ...
              <p class="section-text">
                At Furry Friends, we believe your dog and cat will love their food so much that if they don’t … we’ll help you
                find a
    ...
    <footer class="footer" style="background-image: url('./assets/images/footer-bg.jpg')">
      <div class="footer-top section">
        <div class="container">
          <div class="footer-brand">
            ...
            <p class="footer-text">
              If you have any question, please contact us at <a href="mailto:furryfrinends777@gmail.com"
                class="link">furryfrinends777@gmail.com</a>
            </p>
            <ul class="contact-list">
              <li class="contact-item">
                <ion-icon name="location-outline" aria-hidden="true"></ion-icon>
                <address class="address">
                  Near DYPCET Kolhapur.
                </address>
              </li>
              <li class="contact-item">
                <ion-icon name="call-outline" aria-hidden="true"></ion-icon>
                <a href="tel:+917972539797" class="contact-link">(+91) 7972539797</a>
              </li>
            </ul>
      ...
      <div class="footer-bottom">
        <div class="container">
          ...
          <p class="copyright">
            &copy; 2024 Made with ♥ by <a href="#" class="copyright-link">Group 1 of TYC</a>
          </p>
